...
const INITIAL_STOCKS: Stock[] = [
  { id: '1', name: 'TechKidz Inc', symbol: 'TECH', basePrice: 150, currentPrice: 150, change: 0 },
  { id: '2', name: 'GameWorld Corp', symbol: 'GAME', basePrice: 85, currentPrice: 85, change: 0 },
  { id: '3', name: 'Sweet Treats Co', symbol: 'SWET', basePrice: 42, currentPrice: 42, change: 0 },
  { id: '4', name: 'EcoFriendly Ltd', symbol: 'ECO', basePrice: 120, currentPrice: 120, change: 0 },
  { id: '5', name: 'SpaceExplorers', symbol: 'SPCE', basePrice: 200, currentPrice: 200, change: 0 },
  { id: '6', name: 'PetPals Group', symbol: 'PETS', basePrice: 55, currentPrice: 55, change: 0 },
];
